 ...
 */
package me.jessyan.mvpart.demo.mvp.model.api.cache;
...
public interface CommonCache {
    ...
    @LifeCache(duration = 2, timeUnit = TimeUnit.MINUTES)
    Observable<Reply<List<Time>>> getTime(Observable<List<Time>> times,DynamicKey idLastUserQueried, EvictProvider evictProvider);
}
