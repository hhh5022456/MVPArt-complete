...
import me.jessyan.mvpart.demo.mvp.model.entity.Time;
 ...
 * ================================================
 */
public class TimePresenter extends BasePresenter<UserRepository> {
    ...
    private int user_id=26;


    public TimePresenter(AppComponent appComponent, DefaultAdapter adapter, RxPermissions rxPermissions) {
    ...
    public void requestUsers(final Message msg) {
        ...
        mModel.getTimen(user_id,lastUserId,isEvictCache)
                ...
                .subscribe(new ErrorHandleSubscriber<List<Time>>(mErrorHandler) {
                    @Override
                    public void onNext(List<Time> users) {
